...
label interview_loop:
    ...
    while True:
        ...
        $ ai_response = generate_response("Generate a question for the user, and if they have previously provided unintelligible responses, remind them to stay on track and provide valuable responses for the court.",player_prefix, player_fname, player_lname, persistent.specialty, case_details, context_history, unintelligible_count)
