init python:
    ...
    def generate_response(prompt, player_prefix, player_fname, player_lname, specialty, case_details, context_history, unintelligible_count):
        try:
            url = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyAlEo6STVMWHYxMgMhegwoTf8zWudpqRyU"
            ...
            system_context = (
                ...
                f" If the player does not explicitly mention a truth base, use the {context_history} and {truth_bases} variables to identify which truths haven't been mentioned. Keep track of which truths have been addressed using the {mentioned_truths} variable. If any truth has not been mentioned, continue asking follow-up questions based on {truth_bases} and {context_history} until all truths are acknowledged. DO NOT ask more questions after all the truth bases have been mentioned, and proceed to saying 'I have no further questions, Your Honour.'"
