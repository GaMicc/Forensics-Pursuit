    ...
    showif analyzed["fingerprint"]:
        hbox:
            ...
            imagebutton:
                ...
                action SetVariable("evidence_desc", "This is the fingerprint we gathered from the light switch next to the door knob.")
    ...
    showif analyzed["handprint"]:
        hbox:
            ...
            imagebutton:
                ...
                action SetVariable("evidence_desc", "This is the handprint we gathered from the door. It is slightly degraded.")
    ...
    showif analyzed["footprint packaged"]:
        hbox:
            ...
            imagebutton:
                ...
                action If(analyzed["footprint presumptive"], SetVariable("evidence_desc", "This is blood gathered from the footprint."), SetVariable("evidence_desc", "This is the red substance gathered from the footprint. It is unknown what this substance is at the moment."))
    ...
    showif analyzed["splatter packaged"]:
        hbox:
            ...
            imagebutton:
                ...
                action If(analyzed["splatter presumptive"], SetVariable("evidence_desc", "This is blood gathered from the splatter beside the table."), SetVariable("evidence_desc", "This is the red substance gathered from the splatter beside the table. It is unknown what this substance is at the moment."))
