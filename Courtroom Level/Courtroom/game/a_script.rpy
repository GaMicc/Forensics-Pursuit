init python:
    ...
    def generate_response(prompt):
        ...
        try:
            ...
            # TODO: Replace the case description with your case details (line 47)
            system_context = (
                ...
                f"The player will testify about the following case: An unknown body was discovered floating in a lake in a public park by a passer-by. The victim was later identified by family as 13 year old Jacob DeSouza. The cause of death appears to be strangulation, and not drowning. The accused is his adoptive father, Kiernan DeSouza. Kiernan had been reported absent from work and was not at home around the time of Jacob's death. Furthermore, Kiernan's car was discovered near the lake where the body was found. The investigation has been complicated by the lack of direct witnesses and evidence of forced entry into the home."
