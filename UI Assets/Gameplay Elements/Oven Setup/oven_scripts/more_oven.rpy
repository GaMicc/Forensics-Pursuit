...
screen oven_keyboard():
    ...
    vbox:
        align (0.825, 0.72)
        imagebutton:
            idle "backspace_button_idle.png"
            hover "backspace_button_hover.png"
...
screen main_interface:
    ...
    $ temperature = "350" if temp.hundred_digit == None and temp.ten_digit == None and temp.one_digit == None else f"{temp.hundred_digit}{temp.ten_digit}{temp.one_digit}"
...
label incorrect_label:
    ...
    s "This isn't quite right... Let's do this again!"
    $ on_timer = False
    $ on_temperature = False
